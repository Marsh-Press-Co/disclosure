---
id: "dow-uap-d48-report-september-1996"
...
record_type: "report"
incident_date: "1996-09-10"
year_inferred: false
incident_location: ""
description: "This report describes the Modeling of Unlikely Space-Booster Failures in Risk Calculations, documenting historical launch failure modes and recommending corrective actions to address them using novel modelling techniques."
pages: 181
source_sha256: "0dc72877cdf9cc3a1645c3c9d282928922b00e8fd9ffd7b1daf66f46c72b2071"
...
*Image: A technical diagram labeled “UNCLASSIFIED” showing a plotted rocket impact trace with multiple dotted and solid trajectory lines annotated “15 SEC.,” “18 SEC.,” “20 SEC.,” “25 SEC.,” and “30 SEC.,” plus side labels such as “ALTER,” “PRIME CNTRAVES?,” and “CNTRAVES?,” and the title “JOUST1761-H / CYBER R / IP MAP 1.”*
...
*Image: Black-and-white technical diagram/map labeled “Figure 2. Atlas IIAS Risk Contours for Inner-Ear Injury with A = 3.0,” showing a city street/road layout overlaid with contour lines, numerous plotted symbols and markers, and handwritten-style annotations including “Atlas IIAS Inner Ear Injury Mode-5 A = 3.0” and contour labels “10^-6,” “10^-5,” and “10^-4.”*
...
*Image: A black-and-white scientific map/diagram titled “Atlas IIAS Risk Contours for Inner-Ear Injury with A = 3.5,” showing contour lines labeled 10^-6, 10^-5, and 10^-4 over a site map with roads, many plotted symbols, and a dense cluster of markers near the center.*
...
*Image: A black-and-white line graph titled “Atlas IIAS Failures through 280 sec” showing three plotted curves with legend entries for random-attitude turns, slow turns, and combined turns (0.75 random + 0.25 slow); x-axis labeled “Angle From Flight Path (deg)” from 0 to 180 and y-axis labeled “Percent in 5-deg sector (%)” on a logarithmic scale, with caption “Figure 5. Combined Random-Attitude and Slow-Turn-Results.”*
...
*Image: A black-and-white line chart titled “Atlas IIAS,” plotting Breakup Percent (%) versus Failure Time (sec) from 0 to 280, with three curves labeled q-alpha = 5,000, 10,000, and 20,000 deg-lb/ft².*
...
*Image: A technical diagram labeled “Figure 7. Atlas IIAS Impacts with No Breakup,” showing a large dotted circular impact footprint over an outlined map-like coastline, with vertical text reading “Atlas IIAS Impacts Random-Attitude Failures at 130 sec. Thrust to 280 sec. No Breakup.”*
...
*Image: Black-and-white technical map/diagram labeled “Figure 8. Atlas IIAS Impacts with Breakup,” showing a stippled circular debris-impact pattern over a simplified coastline map, with rotated annotation reading “Atlas IIAS impacts / Random-Attitude failures at 130 sec. / Thrust to 280 sec. / Breakup q-alpha = 5,000 deg-lb/ft².”*
...
*Image: A plotted line graph titled “Atlas IIAS Random-Attitude Failures through 280 sec,” with axes labeled “Percent in 5-deg sector (%)” and “Angle From Flight Path (deg),” multiple curves with a legend for breakup q-alpha categories (no breakup, 20,000, 10,000, 5,000) and A values (3.40, 4.30, 4.75, 5.00), captioned “Figure 11. Atlas IIAS Simulation Results with B = 100,000.”*
...
*Image: A line graph titled “Atlas IIAS Random-Attitude Failures through 280 sec” with axes “Percent in 5-deg sector (%)” and “Angle From Flight Path (deg),” showing multiple plotted curves and a legend for breakup q-alpha values (no breakup, 20,000, 10,000, 5,000) and A values (A = 4.00, 4.80, 5.30, 5.55) with caption “Figure 12. Atlas IIAS Simulation Results with B = 500,000.”*
...
*Image: A line graph titled “Atlas IIAS Random-Attitude Failures through 280 sec” with y-axis “Percent in 5-deg sector (%)” and x-axis “Angle From Flight Path (deg),” showing multiple plotted curves and a legend for breakup q-alpha values (no breakup, 20,000, 10,000, 5,000) and B = 5,000,000 with A values 4.75, 5.65, 6.70, and 6.30; caption below reads “Figure 13. Atlas IIAS Simulation Results with B = 5,000,000.”*
...
*Image: A line graph labeled “Figure 14. Effects of Breakup q-alpha on A for Atlas IIAS,” showing five downward-sloping lines annotated B = 5,000,000; 500,000; 100,000; 50,000; and 1,000, with axes “Mode-5 Constant A” and “Breakup q-alpha (deg-lb/ft²)” and the text “Atlas IIAS” inside the plot.*
...
*Image: A line graph labeled “Figure 15. Mode-5 Density-Function Values at Three Miles,” with five plotted curves and a legend listing A and B values; x-axis “Theta (deg)” from 0 to 180, y-axis “Mode-5 Density-Function Value” on a logarithmic scale from 10^-5 to 10^-2.*
...
*Image: A plotted chart titled “Figure 18. Atlas IIAS Mode-5 Ship-Hit Contours with A = 3.45,” showing two dashed contour shapes on x-y axes labeled “Downrange Distance (nm)” and “Crossrange Distance (nm),” with annotations “Atlas IIAS,” “Mode 5 P1,” “10^-5,” “10^-6,” and “B = 1,000 / A = 3.45.”*
...
*Image: A line graph titled “Atlas IIAS” showing “Percent Impacts in 10-nm Interval” versus “Impact Range (nm),” with four labeled curves: “Theoretical,” “Breakup q-alpha = 5,000 deg-lb/ft²,” “Breakup q-alpha = 20,000 deg-lb/ft²,” and “No Breakup”; caption below reads “Figure 22. Impact-Range Distributions.”*
...
*Image: A scientific line graph labeled “Figure 25. Delta-GEM Simulation Results with Best-Fit Shaping Constants,” showing multiple plotted curves on a logarithmic y-axis (“Percent in 5-deg sector (%)”) versus x-axis (“Angle From Flight Path (deg)” from 0 to 180), with an in-graph legend referencing breakup q-alpha values (no breakup, 20,000, 10,000, 5,000) and shaping constants A and B.*
...
*Image: A line graph titled “Titan IV” showing breakup percent versus failure time (sec), with three plotted curves labeled q-alpha = 5,000, 10,000, and 20,000 deg-lb/ft², and the caption “Figure 26. Titan IV Breakup Percentages.”*
...
*Image: A plotted line graph titled “LLV1 Random-Attitude Failures through 290 sec” with multiple curves and a legend for breakup q-alpha values (no breakup, 20,000, 10,000, 5,000 deg-lb/ft²) and B = 1,000 with A values 1.85, 2.60, 2.70, and 2.75; axes read “Percent in 5-deg sector (%)” and “Angle From Flight Path (deg),” with caption “Figure 30. LLV1 Simulation Results with B = 1,000.”*
