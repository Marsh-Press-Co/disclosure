"""Download PURSUE Release 2..5 PDF/image documents into
raw/pursue-r2r3/documents/ (dir name predates R4/R5; kept to avoid path churn).

Source of truth: raw/pursue-r2r3/uap-data-master.csv (the official war.gov
uap-data.csv, refreshed 2026-08-12 - covers all 5 releases; this script filters
to Release Date 5/22/26 (R2), 6/12/26 (R3), 7/10/26 (R4), 8/7/26 (R5),
Type in {PDF, IMG}).
...
RELEASE_BY_DATE = {"5/22/26": "PURSUE-R2", "6/12/26": "PURSUE-R3", "7/10/26": "PURSUE-R4", "8/7/26": "PURSUE-R5"}
PREFIX_BY_RELEASE = {"PURSUE-R2": "pursue-r2", "PURSUE-R3": "pursue-r3", "PURSUE-R4": "pursue-r4", "PURSUE-R5": "pursue-r5"}
